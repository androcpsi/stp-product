"""
Django settings for stdpalletingproduct project.
...
ROOT_URLCONF = 'stdpalletingproduct.urls'
...
WSGI_APPLICATION = 'stdpalletingproduct.wsgi.application'
